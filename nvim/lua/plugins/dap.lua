...
vim.keymap.set('t', '<F3>', '<C-u><C-k>make<CR>')
...
vim.fn.sign_define('DapBreakpointCondition', { text = '󰀨', texthl = '', linehl = '', numhl = '' })
vim.fn.sign_define('DapLogPoint', { text = '󰋼', texthl = '', linehl = '', numhl = '' })
